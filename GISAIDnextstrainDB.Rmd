...
dfAugurNextclade <- merge( x = augurDF, y = nextcladeDF, by = "gisaid_epi_isl", all = TRUE)

View(dfAugurNextclade)

dfAugurNextclade$date.x <- as.Date(dfAugurNextclade$date.x,  format = "%m/%d/%y")
...
dfAugurNextclade<- (dfAugurNextclade[order(dfAugurNextclade$date.x ),])
...
#write_excel_csv(dfAugurNextclade, file = "/Users/matthewgeniza/Desktop/dfAugurNextclade01062022.csv")

#DB <- read_csv("dfAugurNextclade_OR08232021.csv")
```


#  lineage counts in total datafram
...
september2020Counts <-dfAugurNextclade[dfAugurNextclade$date.x >= "2020-09-01" & dfAugurNextclade$date.x <= "2020-09-30", ]
...
#inOmicronOnePtFull <- filter(dfAugurNextclade, pangolin_lineage == "B.1.1.529" | pangolin_lineage == "BA.1" ) 
inOmicronOnePt <- filter(megaFullSetDelSub,  pangolin_lineage == "BA.1.1" )


View(inOmicronOnePt)

inOmicronOnePtCount = count(inOmicronOnePt, inOmicronOnePt$gisaid_epi_isl)
inOmicronOnePtGisaid <- (inOmicronOnePtCount[order(-inOmicronOnePtCount$n ),])
View(inOmicronOnePtGisaid)
#write.xlsx(inOmicronOnePt, file = "/Users/matthewgeniza/Desktop/inOmicronOnePt.xlsx", sheetName = "Sheet1", row.names = TRUE)
#write.xlsx(inOmicronOnePtGisaid, file = "/Users/matthewgeniza/Desktop/inOmicronOnePtGisaid.xlsx", sheetName = "Sheet1", row.names = TRUE)
#genotype count
inOmicronOnePtCountGenotype = count(inOmicronOnePt, inOmicronOnePt$pangolin_lineage)
inOmicronOnePtGenotype <- (inOmicronOnePtCountGenotype[order(-inOmicronOnePtCountGenotype$n ),])
#write.xlsx(inOmicronOnePtGenotype, file = "/Users/matthewgeniza/Desktop/inOmicronOnePtGenotype.xlsx", sheetName = "Sheet1", row.names = TRUE)
View(inOmicronOnePtGenotype)
#substitution count
inOmicronOnePtCountSubstitution = count(inOmicronOnePt, inOmicronOnePt$substitutions)
inOmicronOnePtSubstitution <- (inOmicronOnePtCountSubstitution[order(-inOmicronOnePtCountSubstitution$n ),])

#write.xlsx(inOmicronOnePtSubstitution, file = "/Users/matthewgeniza/Desktop/inBA2Substitution.xlsx", sheetName = "Sheet1", row.names = TRUE)
View(inOmicronOnePtSubstitution)
...
#write.xlsx(inAlphaSubstitution, file = "/Users/matthewgeniza/Desktop/inAlphaSubstitution.xlsx", sheetName = "Sheet1", row.names = TRUE)
